...
}
{
	...
	\exTwoM{S_1} e \exTwoM{S_2} (poichè $S_1$ e $S_2$ sono sottoprogrammi di
	...
	\item \casoinduttivo{S=\ifABC{b}{S_1}{S_2}}: Devo dimostrare che
	\exTwoM{\ifABC{b}{S_1}{S_2}}, avendo come ipotesi induttive
	\exTwoM{S_1} e \exTwoM{S_2} (poichè $S_1$ e $S_2$ sono sottoprogrammi di
	$S$). Suppongo per ipotesi che valga 
	...
	\item \casoinduttivo{S=\wbS{b}{S_1}}: è sufficiente fare l'unfolding e
